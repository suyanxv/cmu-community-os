...
const CreateEventSchema = z.object({
  ...
  location_name: z.string().transform(v => v || null).nullable(),
  ...
  target_audience: z.string().transform(v => v || null).nullable(),
  channels: z.array(z.string()).default([]),
  rsvp_link: z.string().transform(v => v || null).nullable(),
  rsvp_deadline: z.string().transform(v => v || null).nullable(),
